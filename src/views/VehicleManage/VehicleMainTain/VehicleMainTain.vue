...
import AddMainTain from "./components/AddMainTain";
...
export default {
  ...
  data() {
    return {
      ...
      //当前行的数据
      editForm: {},
      fTableView: "t_Vehicle_Maintain_Mst",
      ...
      batchDelTableName: [
        {
          Key: "t_Maintain_InsideParts",
          Value: [{ Key: "fID", Value: "fMstID" }]
        },
        {
          Key: "t_Maintain_OutsideParts",
          Value: [{ Key: "fID", Value: "fMstID" }]
        },
        {
          Key: "t_Maintain_Content",
          Value: [{ Key: "fID", Value: "fMstID" }]
        }
      ],
      //表头的字段，以及自增长字段
      fTableViewHead: ["t_Vehicle_Maintain_Mst", "fID"],
      //表格的ftableview,自增长字段
      fTableViewItem: [
        "t_Maintain_InsideParts",
        "t_Maintain_OutsideParts",
        "t_Maintain_Content",
        "fMstID"
      ],
      //表单需要下拉选择的数据
