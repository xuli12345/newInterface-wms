<template>
  <div>
    <HomeTable
      ...
      :tableName="'t_Vehicle_Repair_Mst'"
...
import AddVehicleRepair from "./components/AddVehicleRepair";
import EditVehicleRepair from "./components/EditVehicleRepair";
export default {
  components: {
    HomeTable,
    AddVehicleRepair,
  ...
  data() {
    return {
      ...
      //当前行的数据
      editForm: {},
      fTableView: "t_Vehicle_Repair_Mst",
      //是否新增成功
      isSaveSuccess: false,
      //批量删除的数据
      batchDelTableName: [
      ...
      //表头的字段，以及自增长字段
      fTableViewHead: ["t_Vehicle_Repair_Mst", "fID"],
      //表格的ftableview,自增长字段
      fTableViewItem: [
        "t_Repair_InsideParts",
        "t_Repair_OutsideParts",
        "t_Repair_Content",
        "fMstID"
      ],
      //   字表数据
      ItemTableData: [
        {
          apiUrl: "t_Repair_InsideParts",
          fColumnDes: "内部配件",
          IdentityColumn: "fMstID",
          fName: "inside"
        },
        {
          apiUrl: "t_Repair_OutsideParts",
          fColumnDes: "外部配件",
          IdentityColumn: "fMstID",
          fName: "outside"
        },
        {
          apiUrl: "t_Repair_Content",
          fColumnDes: "维修内容",
          IdentityColumn: "fMstID",
          fName: "content"
        }
      ...
      selectArr: [
        ...
        {
          fName: "fRepairTypeName",
          fUrl: "v_Type_Vehicle_Repair",
          fDes: "fTypeName",
          fID: "fID",
          fAuto: ["fRepairTypeID"],
          fAutoID: ["fRepairTypeID"]
        }
      ],
      selectArr2: [
        {
