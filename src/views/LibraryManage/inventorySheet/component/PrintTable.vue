<template>
  <div ref="toPrint">
    ...
    <h3
      style="font-size:20px;margin-bottom:10px;display: flex;  align-items: center;  justify-content: center;"
    >
      {{ title[1] }}
    </h3>
    <p class="page" style="display: flex; justify-content: flex-end;font-size:20px;">
      单据打印时间:{{ dataTime }}
    </p>
    <div v-for="(item, index) in tableData" :key="index">
      <div
        style="margin-top:15px; margin-left:20px;display: flex;align-items: center;font-size:20px"
      >
        <span style="flex:1"
